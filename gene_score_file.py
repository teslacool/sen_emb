...
parser.add_argument("--thre2",type=str, default=0)
params = parser.parse_args()
dir = params.dir
src_f = dir + params.src_f
tgt_f = dir + params.tgt_f
sco_f = dir + params.sco_f
gen_f = dir + 'out_' + sco_f[-2:] + '_02'

threshold1 = 0.7
threshold2 = float(params.thre2)
print("threshold2:%f"%float(threshold2))
                ...
                while True:
                    ...
                    if src_sen=='':
                        if tgt.readline()=='' and sco.readline()=='':
                            print("successul!")
                            print("filter/obtain {}/{}".format(filter,obtain))
                        else:
                            print("one error!")
                        break
