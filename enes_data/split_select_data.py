...
fde_out = open('enes.es.'+threshold2, 'w', encoding='utf-8')
fen_out = open('enes.en.'+threshold2, 'w', encoding='utf-8')
fscore_out = open('enes.score.'+threshold2, 'w', encoding='utf-8')
for i in range(13):
